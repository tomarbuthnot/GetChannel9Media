# Import any additional modules stored within this module
# Get the folders within this module folder, foreach of them check if they contain a module and load that module
# Second get-childitem imports all the ps1 functions
Get-ChildItem $psscriptroot | Where-Object { $_.PSIsContainer } |Foreach-Object {Get-Childitem "$($_.PSPath)\*.psm1"} | % { Import-Module "$($_.FullName)" -Verbose:$VerbosePreference -Force}

Get-Childitem $psscriptroot\*.ps1 | % { . $_.FullName -Verbose:$VerbosePreference}
# SIG # Begin signature block
# MIIQGQYJKoZIhvcNAQcCoIIQCjCCEAYCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU827miA9yLADdxMxmpOlWQZ96
# EPiggg1eMIIGozCCBYugAwIBAgIQD6hJBhXXAKC+IXb9xextvTANBgkqhkiG9w0B
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBT1jabbfqm5ECuQ
# Hsx9B+TUF+yzFTANBgkqhkiG9w0BAQEFAASCAQCkJFuRwsdCL+Gyj+du8LnlKeTC
# B+1Mo7FNUtb55c8ZVuu6F2eIIZ0JYZ0afkH24labNYyRs5TuloSqKzcY4uySqZ7T
# AmkX5usYmmvUcYnOvy0txSLeAUOoPpfX/P60VEXADl/+E1/PjIwX0Nc54Vih/Q/U
# nNUOZw0Dxv0uXN+Ak83WsBBINo2ndqPoHQ7fPe9RC6aUvi4ZaL0JTKaLGxdYFfMu
# 7n6FNBhR4THWsdXEvhsQLVwxsHOibWXQPYSBR/c627qCLWEZH9he0CIFcQJ7Tlyx
# V4BaKc7WUJIqtXrTCF77cSzJ3TpzcZL2Iy7FbYPwDE+K0zNG83U6fd23MHbr
